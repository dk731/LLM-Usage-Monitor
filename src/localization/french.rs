...
pub(super) const STRINGS: Strings = Strings {
    ...
    kimi_model: "Kimi",
    kimi_window_title: "Moniteur d'utilisation Kimi",
    kimi_token_expired_title: "Erreur d'authentification Kimi",
    kimi_token_expired_body: "Votre session Kimi a expiré. Enregistrez un nouveau jeton d'actualisation dans kimi.json, puis actualisez ou redémarrez cette application.",
    copilot_model: "Copilot",
    copilot_window_title: "Moniteur d'utilisation Copilot",
    copilot_token_expired_title: "Erreur d'authentification Copilot",
    copilot_token_expired_body: "Verifiez copilot.json dans le dossier de l'application. Le jeton doit avoir un acces en lecture a la facturation de l'organisation et ne pas etre expire.",
    bar_length: "Longueur de barre",
    bar_length_auto: "Auto",
    second_suffix: "s",
};
