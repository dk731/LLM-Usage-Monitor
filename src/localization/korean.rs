...
pub(super) const STRINGS: Strings = Strings {
    ...
    kimi_model: "Kimi",
    kimi_window_title: "Kimi 사용량 모니터",
    kimi_token_expired_title: "Kimi 인증 오류",
    kimi_token_expired_body: "Kimi 로그인이 만료되었습니다. 새 리프레시 토큰을 kimi.json에 저장한 다음 이 앱을 새로 고치거나 다시 시작하세요.",
    copilot_model: "Copilot",
    copilot_window_title: "Copilot 사용량 모니터",
    copilot_token_expired_title: "Copilot 인증 오류",
    copilot_token_expired_body: "앱 폴더의 copilot.json을 확인하세요. 토큰에는 조직 청구 읽기 권한이 필요하며 만료되지 않아야 합니다.",
    bar_length: "막대 길이",
    bar_length_auto: "자동",
    second_suffix: "초",
};
