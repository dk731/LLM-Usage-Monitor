...
pub(super) const STRINGS: Strings = Strings {
    ...
    kimi_model: "Kimi",
    kimi_window_title: "Kimi 使用量モニター",
    kimi_token_expired_title: "Kimi 認証エラー",
    kimi_token_expired_body: "Kimi のログインの有効期限が切れました。新しいリフレッシュトークンを kimi.json に保存してから、このアプリを更新または再起動してください。",
    copilot_model: "Copilot",
    copilot_window_title: "Copilot 使用量モニター",
    copilot_token_expired_title: "Copilot 認証エラー",
    copilot_token_expired_body: "アプリフォルダーの copilot.json を確認してください。トークンには組織の請求情報への読み取り権限が必要で、有効期限が切れていないことも必要です。",
    bar_length: "バーの長さ",
    bar_length_auto: "自動",
    second_suffix: "秒",
};
