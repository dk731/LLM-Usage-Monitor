...
pub(super) const STRINGS: Strings = Strings {
    ...
    kimi_model: "Kimi",
    kimi_window_title: "Monitor de uso do Kimi",
    kimi_token_expired_title: "Erro de Autenticação do Kimi",
    kimi_token_expired_body: "Seu login do Kimi expirou. Salve um novo token de atualização em kimi.json e atualize ou reinicie este aplicativo.",
    copilot_model: "Copilot",
    copilot_window_title: "Monitor de uso do Copilot",
    copilot_token_expired_title: "Erro de Autenticação do Copilot",
    copilot_token_expired_body: "Verifique copilot.json na pasta do aplicativo. O token precisa de acesso de leitura ao faturamento da organizacao e nao pode estar expirado.",
    bar_length: "Comprimento da barra",
    bar_length_auto: "Automático",
};
