...
pub(super) const STRINGS: Strings = Strings {
    ...
    kimi_model: "Kimi",
    kimi_window_title: "Kimi 使用量監控",
    kimi_token_expired_title: "Kimi 驗證錯誤",
    kimi_token_expired_body: "您的 Kimi 登入已過期。請將新的重新整理權杖儲存至 kimi.json，然後重新整理或重新啟動此應用程式。",
    copilot_model: "Copilot",
    copilot_window_title: "Copilot 使用量監控",
    copilot_token_expired_title: "Copilot 驗證錯誤",
    copilot_token_expired_body: "請檢查應用程式資料夾中的 copilot.json。權杖需要組織帳務的讀取權限，且不得過期。",
    bar_length: "長條長度",
    bar_length_auto: "自動",
    second_suffix: "秒",
};
