...
pub(super) const STRINGS: Strings = Strings {
    ...
    kimi_model: "Kimi",
    kimi_window_title: "Kimi-Nutzungsmonitor",
    kimi_token_expired_title: "Kimi-Authentifizierungsfehler",
    kimi_token_expired_body: "Deine Kimi-Anmeldung ist abgelaufen. Speichere ein neues Refresh-Token in kimi.json und aktualisiere oder starte diese App neu.",
    copilot_model: "Copilot",
    copilot_window_title: "Copilot-Nutzungsmonitor",
    copilot_token_expired_title: "Copilot-Authentifizierungsfehler",
    copilot_token_expired_body: "Prüfe copilot.json im App-Ordner. Das Token benötigt Lesezugriff auf die Organisationsabrechnung und darf nicht abgelaufen sein.",
    bar_length: "Balkenlänge",
    bar_length_auto: "Automatisch",
    second_suffix: "s",
};
