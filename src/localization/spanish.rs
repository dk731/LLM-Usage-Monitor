...
pub(super) const STRINGS: Strings = Strings {
    ...
    kimi_model: "Kimi",
    kimi_window_title: "Monitor de uso de Kimi",
    kimi_token_expired_title: "Error de autenticacion de Kimi",
    kimi_token_expired_body: "Tu sesión de Kimi ha caducado. Guarda un nuevo token de actualización en kimi.json y luego actualiza o reinicia esta aplicación.",
    copilot_model: "Copilot",
    copilot_window_title: "Monitor de uso de Copilot",
    copilot_token_expired_title: "Error de autenticacion de Copilot",
    copilot_token_expired_body: "Revisa copilot.json en la carpeta de la aplicacion. El token necesita acceso de lectura a la facturacion de la organizacion y no debe estar caducado.",
    bar_length: "Longitud de barra",
    bar_length_auto: "Automatico",
    second_suffix: "s",
};
