...
pub(super) const STRINGS: Strings = Strings {
    ...
    kimi_model: "Kimi",
    kimi_window_title: "Kimi Usage Monitor",
    kimi_token_expired_title: "Kimi Auth Error",
    kimi_token_expired_body: "Your Kimi sign-in has expired. Save a new refresh token in kimi.json, then refresh or restart this app.",
    copilot_model: "Copilot",
    copilot_window_title: "Copilot Usage Monitor",
    copilot_token_expired_title: "Copilot Auth Error",
    copilot_token_expired_body: "Check copilot.json in the app folder. The token needs org billing read access, and must not be expired.",
