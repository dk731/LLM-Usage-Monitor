...
pub(super) const STRINGS: Strings = Strings {
    ...
    kimi_model: "Kimi",
    kimi_window_title: "Kimi-gebruiksmonitor",
    kimi_token_expired_title: "Kimi-authenticatiefout",
    kimi_token_expired_body: "Je Kimi-aanmelding is verlopen. Sla een nieuw refresh-token op in kimi.json en vernieuw of herstart deze app.",
    copilot_model: "Copilot",
    copilot_window_title: "Copilot-gebruiksmonitor",
    copilot_token_expired_title: "Copilot-authenticatiefout",
    copilot_token_expired_body: "Controleer copilot.json in de app-map. Het token heeft leesrechten voor organisatiefacturering nodig en mag niet verlopen zijn.",
    bar_length: "Balklengte",
